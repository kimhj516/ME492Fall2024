...
public:
    ...
    double compute_acceleration(double current_vertical_velocity, double current_height);
    double compute_vertical_velocity(double current_acceleration, double current_vertical_velocity);
