...
int main (int argc, char *argv[])
{
    ...
    command_line_options.add_options()
        ("acceleration",
         boost::program_options::value<double>(&acceleration)->default_value(-9.81),
         "input gravitational acceleration")
        ("mass",
         boost::program_options::value<double>(&mass)->default_value(80.0),
         "input bungee jumper's mass")
        ("drag_coefficient",
         boost::program_options::value<double>(&drag_coefficient)->default_value(0.25),
         "input drag coefficient")
        ("initial_vertical_velocity",
         boost::program_options::value<double>(&initial_vertical_velocity)->default_value(0.0),
         "input initial vertical velocity")
        ("initial_height",
         boost::program_options::value<double>(&initial_height)->default_value(250.0),
         "input initial height")
        ("bottom_height",
         boost::program_options::value<double>(&bottom_height)->default_value(10.0),
         "input bottom height")
        ("spring_constant",
         boost::program_options::value<double>(&spring_constant)->default_value(10.0),
         "input spring constant")
        ("cord_length",
         boost::program_options::value<double>(&cord_length)->default_value(200.0),
         "input cord length")
        ("time_step_size",
         boost::program_options::value<double>(&time_step_size)->default_value(0.01),
